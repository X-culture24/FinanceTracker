...
SECRET_KEY = 'django-insecure-da9soz8)wz($8erildj-_j!10qmck2(ea57-g_l+rj40ovz@wi'
...
DATABASES = {
    'default': {
        ...
        'USER': config('DB_USER', default='golf'),
        'PASSWORD': config('DB_PASSWORD', default='golf123'),
